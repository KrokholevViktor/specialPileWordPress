...
$opt_name = 'specialpile_options';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
...
$args = array(
	...
	'menu_title'                => esc_html__( 'Настройки темы', 'specialpile' ),

	// The text to appear on the page title.
	'page_title'                => esc_html__( 'Настройки темы', 'specialpile' ),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Site Settings', 'specialpile' ),
		'id'               => 'site_settings',
		'desc'             => esc_html__( 'These are really basic fields!', 'specialpile' ),
		'customizer_width' => '400px',
		'icon'             => 'el el-road',
	)
);
Redux::setSection( $opt_name, array(
	'title'            => esc_html__( 'Настройки Шапки', 'specialpile' ),
	'id'               => 'site_settings_header',
	'subsection'       => true,
	'customizer_width' => '450px',
	'desc'             => __( 'Настройки для шапки. Если оставить поле пустым и сохранить изменения, то элемент пропадёт со страницы', 'specialpile' ),
	'fields'           => array(
		
		array(
			'id'       => 'phone',
			'type'     => 'text',
			'title'    => __( 'Телефон', 'specialpile' ),
			'subtitle' => __( 'Введите телефон', 'specialpile' ),
			'desc'     => __( 'Телефон', 'specialpile' ),
			'default'  => '',
		),
		array(
			'id'       => 'email',
			'type'     => 'text',
			'title'    => __( 'E-mail', 'specialpile' ),
			'subtitle' => __( 'Введите Email', 'specialpile' ),
			'desc'     => __( 'E-mail', 'specialpile' ),
			'default'  => '',
		),
		array(
			'id'       => 'button',
			'type'     => 'text',
			'title'    => __( 'Текст кнопки в шапке', 'specialpile' ),
			'subtitle' => __( 'Введите текст кнопки', 'specialpile' ),
			'desc'     => __( 'Текст кнопки в шапке', 'specialpile' ),
			'default'  => '',
		),
		array(
			'id'       => 'header_logo',
			'type'     => 'media',
			'title'    => __( 'Лого сайта', 'specialpile' ),
			'subtitle' => __( 'Добавьте изображение логотипа сайта', 'specialpile' ),
		),
...
Redux::setSection( $opt_name, array(
	'title'            => esc_html__( 'Ссылки навигации по сайту', 'specialpile' ),
	'id'               => 'site_settings_links',
	'subsection'       => true,
	'customizer_width' => '450px',
	'desc'             => __( 'Ссылки навигации по сайту шапка/подвал', 'specialpile' ),
	'fields'           => array(
		
		array(
			'id'       => 'navigation_link1',
			'type'     => 'text',
			'title'    => __( 'Название ссылки 1', 'specialpile' ),
			'subtitle' => __( 'Меняет название ссылки в шапке и подвале', 'specialpile' ),
			'desc'     => __( 'Введите название ссылки', 'specialpile' ),
		),
		array(
			'id'       => 'navigation_link2',
			'type'     => 'text',
			'title'    => __( 'Название ссылки 2', 'specialpile' ),
			'subtitle' => __( 'Меняет название ссылки в шапке и подвале', 'specialpile' ),
			'desc'     => __( 'Введите название ссылки', 'specialpile' ),
		),
		array(
			'id'       => 'navigation_link3',
			'type'     => 'text',
			'title'    => __( 'Название ссылки 3', 'specialpile' ),
			'subtitle' => __( 'Меняет название ссылки в шапке и подвале', 'specialpile' ),
			'desc'     => __( 'Введите название ссылки', 'specialpile' ),
		),
		array(
			'id'       => 'navigation_link4',
			'type'     => 'text',
			'title'    => __( 'Название ссылки 4', 'specialpile' ),
			'subtitle' => __( 'Меняет название ссылки в шапке и подвале', 'specialpile' ),
			'desc'     => __( 'Введите название ссылки', 'specialpile' ),
		),
		array(
			'id'       => 'navigation_link5',
			'type'     => 'text',
			'title'    => __( 'Название ссылки 5', 'specialpile' ),
			'subtitle' => __( 'Меняет название ссылки в шапке и подвале', 'specialpile' ),
			'desc'     => __( 'Введите название ссылки', 'specialpile' ),
		),
		array(
			'id'       => 'navigation_link6',
			'type'     => 'text',
			'title'    => __( 'Название ссылки 6', 'specialpile' ),
			'subtitle' => __( 'Меняет название ссылки в шапке и подвале', 'specialpile' ),
			'desc'     => __( 'Введите название ссылки', 'specialpile' ),
		),
		array(
			'id'       => 'navigation_link7',
			'type'     => 'text',
			'title'    => __( 'Название ссылки 7', 'specialpile' ),
			'subtitle' => __( 'Меняет название ссылки в шапке и подвале', 'specialpile' ),
			'desc'     => __( 'Введите название ссылки', 'specialpile' ),
		),
		array(
			'id'       => 'navigation_link8',
			'type'     => 'text',
			'title'    => __( 'Название ссылки 8', 'specialpile' ),
			'subtitle' => __( 'Меняет название ссылки в шапке и подвале', 'specialpile' ),
			'desc'     => __( 'Введите название ссылки', 'specialpile' ),
		),
		array(
			'id'       => 'navigation_link9',
			'type'     => 'text',
			'title'    => __( 'Название ссылки 9', 'specialpile' ),
			'subtitle' => __( 'Меняет название ссылки в шапке и подвале', 'specialpile' ),
			'desc'     => __( 'Введите название ссылки', 'specialpile' ),
		),
	)
...
Redux::setSection( $opt_name, array(
	'title'            => esc_html__( 'Настройка блока Pomo/Заголовок сайта', 'specialpile' ),
	'id'               => 'site_settings_promo',
	'subsection'       => true,
	'customizer_width' => '450px',
	'desc'             => __( 'Настройка заголовка сайта, изображения блока, названия кнопки и блока услуг', 'specialpile' ),
	'fields'           => array(
		array(
			'id'       => 'promo_image',
			'type'     => 'media',
			'title'    => __( 'Изображение блока Promo', 'specialpile' ),
			'subtitle' => __( 'Добавьте изображение', 'specialpile' ),
		),
		array(
			'id'       => 'promo_title',
			'type'     => 'text',
			'title'    => __( 'Название заголовка сайта', 'specialpile' ),
			'subtitle' => __( 'Меняет название заголовка сайта', 'specialpile' ),
			'desc'     => __( 'Введите название', 'specialpile' ),
		),
		array(
			'id'       => 'promo_service1',
			'type'     => 'text',
...
Redux::setSection( $opt_name, array(
	'title'            => esc_html__( 'Настройки подвала', 'specialpile' ),
	'id'               => 'site_settings_footer',
	'subsection'       => true,
	'customizer_width' => '450px',
	'desc'             => __( 'Настройки для подвала. Если оставить поле пустым и сохранить изменения, то элемент пропадёт со страницы', 'specialpile' ),
	'fields'           => array(
		
		array(
			'id'       => 'footer_logo',
			'type'     => 'media',
			'title'    => __( 'Лого подвала сайта', 'specialpile' ),
			'subtitle' => __( 'Добавьте изображение логотипа подвала сайта', 'specialpile' ),
		),
		array(
			'id'       => 'footer_privacy_policy',
			'type'     => 'text',
			'title'    => __( 'Название для Политики конфиденциальности', 'specialpile' ),
			'subtitle' => __( 'Меняет название ссылки для Политики конфиденциальности', 'specialpile' ),
			'desc'     => __( 'Введите название ссылки', 'specialpile' ),
		),
		array(
			'id'       => 'copyrights',
			'type'     => 'editor',
			'title'    => __( 'Copyrights', 'specialpile' ),
			'subtitle' => __( 'Insert Copyrights', 'specialpile' ),
		),
	)
) );
/*
